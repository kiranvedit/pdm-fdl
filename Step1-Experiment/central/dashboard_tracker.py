...
class ExperimentDashboard:
    ...
    def __init__(self, experiment_name: str = "step1a_central_models_perf_dashboard", output_dir: str = None):
        # Save dashboard and data in the same directory as this script
        script_dir = os.path.dirname(os.path.abspath(__file__))
        self.experiment_name = experiment_name
        self.output_dir = script_dir if output_dir is None else output_dir
        ...
        self.dashboard_path = os.path.join(self.output_dir, "step1a_central_models_perf_dashboard.html")
        self.data_path = os.path.join(self.output_dir, "data", f"{self.experiment_id}.json")
